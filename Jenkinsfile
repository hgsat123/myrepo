...
>>>>>>> c3b6f4bd03dcdcc6048cbebddfb369d0475a402f:sample-app/Jenkinsfile
  ...
  switch (env.BRANCH_NAME) {
    ...
    case "test":
        ...
        sh("sed -i.bak 's#172.31.17.242:5000/sys/gceme:1.0#${imageTag}#' ./k8s/test/*.yaml")
    ...
    case "master":
        ...
        sh("sed -i.bak 's#172.31.17.242:5000/sys/gceme:1.0#${imageTag}#' ./k8s/production/*.yaml")
        sh("kubectl --namespace=production apply -f k8s/services/")
    ...
    default:
        ...
        sh("sed -i.bak 's#172.31.17.242:5000/sys/gceme:1.0#${imageTag}#' ./k8s/dev/*.yaml")
